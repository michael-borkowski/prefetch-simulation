...
public class ConfigurationTest {
   ...
   public void test() {
      ...
      Configuration sut = new Configuration(totalTicks, maximumByterate, slotLength, networkUptime, relativeJitter, absoluteJitter, predictionAccuracy, recurringRequestSeries, intermittentRequests, algorithm, lookAheadTime);
      ...
      assertEquals(733.1, sut.getPredictionAccuracy(), 0.0000001);
